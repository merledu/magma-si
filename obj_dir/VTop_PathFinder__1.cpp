...
VL_INLINE_OPT void VTop_PathFinder::_sequent__TOP__Top__DOT__FDPU__DOT__PathFinder__3(VTop__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          VTop_PathFinder::_sequent__TOP__Top__DOT__FDPU__DOT__PathFinder__3\n"); );
...
VL_INLINE_OPT void VTop_PathFinder::_sequent__TOP__Top__DOT__FDPU__DOT__PathFinder_1__5(VTop__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          VTop_PathFinder::_sequent__TOP__Top__DOT__FDPU__DOT__PathFinder_1__5\n"); );
    VTop* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
