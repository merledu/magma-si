...
VL_CTOR_IMP(VFlexDPU_PathFinder) {
    // Reset internal values
    // Reset structure values
    _ctor_var_reset();
}

void VFlexDPU_PathFinder::__Vconfigure(VFlexDPU__Syms* vlSymsp, bool first) {
...
void VFlexDPU_PathFinder::_settle__TOP__FlexDPU__DOT__PathFinder__9(VFlexDPU__Syms* __restrict vlSymsp) {
    ...
    if (((3U == this->__PVT__Distribution__DOT__part2__DOT__j) 
