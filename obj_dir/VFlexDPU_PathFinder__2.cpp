...
VL_INLINE_OPT void VFlexDPU_PathFinder::_combo__TOP__FlexDPU__DOT__PathFinder_1__66(VFlexDPU__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        VFlexDPU_PathFinder::_combo__TOP__FlexDPU__DOT__PathFinder_1__66\n"); );
...
VL_INLINE_OPT void VFlexDPU_PathFinder::_sequent__TOP__FlexDPU__DOT__PathFinder_2__5(VFlexDPU__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        VFlexDPU_PathFinder::_sequent__TOP__FlexDPU__DOT__PathFinder_2__5\n"); );
    VFlexDPU* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
            ...
            if ((4U != this->__PVT__Distribution__DOT__part2__DOT___GEN_127)) {
                this->__Vdly__Distribution__DOT__part2__DOT__j 
                    = ((IData)(this->__PVT__Distribution__DOT__complete)
                        ? ((0xfU == (0xfU & (IData)(vlTOPp->FlexDPU__DOT___GEN_558)))
                            ? this->__PVT__Distribution__DOT__Jdex_15
                            : ((0xeU == (0xfU & (IData)(vlTOPp->FlexDPU__DOT___GEN_558)))
                                ? this->__PVT__Distribution__DOT__Jdex_14
                                : ((0xdU == (0xfU & (IData)(vlTOPp->FlexDPU__DOT___GEN_558)))
    ...
    if (vlTOPp->reset) {
        ...
        if ((7U == this->__PVT__Distribution__DOT__part2__DOT__j)) {
            if ((((7U == this->__PVT__Distribution__DOT__part2__DOT__j) 
                ...
                this->__Vdly__Distribution__DOT__part3__DOT__i 
                    = ((IData)(1U) + ((0xfU == (0xfU 
                                                & (IData)(vlTOPp->FlexDPU__DOT___GEN_558)))
