...
VL_INLINE_OPT void VTop_PathFinder::_sequent__TOP__Top__DOT__FDPU__DOT__PathFinder__2(VTop__Syms* __restrict vlSymsp) {
              ...
              & ((4U == this->__PVT__Distribution__DOT__part3__DOT___GEN_63) 
                 | ((~ ((7U > this->__PVT__Distribution__DOT__part3__DOT__i) 
                    ...
                    & ((~ ((7U == this->__PVT__Distribution__DOT__part3__DOT__i) 
                       ...
                       & ((7U == this->__PVT__Distribution__DOT__part3__DOT__i) 
                          & (7U == this->__PVT__Distribution__DOT__part3__DOT__j)))))));
    this->__PVT__Distribution__DOT___GEN_518 = (((IData)(this->__PVT__Distribution__DOT__part2_io_Ovalid) 
    ...
    this->__PVT__myMuxes__DOT___GEN_215 = (0xffffU 
                                           & ((7U == 
                                               (7U 
                                                & this->__PVT__myMuxes__DOT__i))
                                               ? ((IData)(this->__PVT__Distribution__DOT___GEN_518)
                                                   ? 
...
VL_INLINE_OPT void VTop_PathFinder::_sequent__TOP__Top__DOT__FDPU__DOT__PathFinder__33(VTop__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          VTop_PathFinder::_sequent__TOP__Top__DOT__FDPU__DOT__PathFinder__33\n"); );
    VTop* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    if (this->__PVT__Distribution__DOT___GEN_518) {
    ...
    this->__PVT__myMuxes_io_mat1_0_7 = ((IData)(this->__PVT__Distribution__DOT___GEN_518)
                                         ? (IData)(vlTOPp->Top__DOT__FDPU__DOT__PathFinder_io_Stationary_matrix_0_7)
                                         : 0U);
