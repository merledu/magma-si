...
VFlexDPU__Syms::VFlexDPU__Syms(VFlexDPU* topp, const char* namep)
    ...
    , TOP__FlexDPU__DOT__flexdpecom4_1__DOT__my_Benes(Verilated::catName(topp->name(), "FlexDPU.flexdpecom4_1.my_Benes"))
    , TOP__FlexDPU__DOT__flexdpecom4_2__DOT__my_Benes(Verilated::catName(topp->name(), "FlexDPU.flexdpecom4_2.my_Benes"))
    , TOP__FlexDPU__DOT__flexdpecom4_3__DOT__my_Benes(Verilated::catName(topp->name(), "FlexDPU.flexdpecom4_3.my_Benes"))
    , TOP__FlexDPU__DOT__flexdpecom4__DOT__my_Benes(Verilated::catName(topp->name(), "FlexDPU.flexdpecom4.my_Benes"))
{
    ...
    TOPp->__PVT__FlexDPU__DOT__flexdpecom4_1__DOT__my_Benes = &TOP__FlexDPU__DOT__flexdpecom4_1__DOT__my_Benes;
    TOPp->__PVT__FlexDPU__DOT__flexdpecom4_2__DOT__my_Benes = &TOP__FlexDPU__DOT__flexdpecom4_2__DOT__my_Benes;
    TOPp->__PVT__FlexDPU__DOT__flexdpecom4_3__DOT__my_Benes = &TOP__FlexDPU__DOT__flexdpecom4_3__DOT__my_Benes;
    TOPp->__PVT__FlexDPU__DOT__flexdpecom4__DOT__my_Benes = &TOP__FlexDPU__DOT__flexdpecom4__DOT__my_Benes;
    ...
    TOP__FlexDPU__DOT__flexdpecom4_1__DOT__my_Benes.__Vconfigure(this, true);
    TOP__FlexDPU__DOT__flexdpecom4_2__DOT__my_Benes.__Vconfigure(this, false);
    TOP__FlexDPU__DOT__flexdpecom4_3__DOT__my_Benes.__Vconfigure(this, false);
    TOP__FlexDPU__DOT__flexdpecom4__DOT__my_Benes.__Vconfigure(this, false);
}
