   ...
   // println(rowcount(0))
    ...
    when(rowcount(0) =/= 0.U){
     ...
     when(valid === true.B){
        ...
        }.elsewhen(rowcount(1+ pin )===4.U &&  ((rowcount(0+ pin ) === 1.U && rowcount(1+ pin ) === 0.U  ) || (rowcount(1+ pin ) === 0.U && rowcount(0+ pin ) === 1.U  )
         )){
             i_vn(1) := 1.U+ pin 
            i_vn(2) := 1.U+ pin 
            i_vn(3) := 1.U+ pin 
        ...
        }.elsewhen(rowcount(1+ pin )===4.U && rowcount(0+ pin ) === 0.U && rowcount(1+ pin ) === 0.U){
            i_vn(0) := 1.U+ pin 
            i_vn(1) := 1.U+ pin 
            i_vn(2) := 1.U+ pin 
            i_vn(3) := 1.U+ pin 
