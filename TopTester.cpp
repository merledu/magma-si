...
int main(int argc, char** argv) {
    ...
    for (int cycle = 0; cycle < 2000; cycle++) {
        if (cycle % 100 == 0) {
            ...
            top->io_Stationary_matrix_0_0 = stationary_matrix[0][0];
            top->io_Stationary_matrix_0_1 = stationary_matrix[0][1];
            top->io_Stationary_matrix_1_0 = stationary_matrix[1][0];
            top->io_Stationary_matrix_1_1 = stationary_matrix[1][1];

            top->io_Streaming_matrix_0_1 = streaming_matrix[0][0];
            top->io_Streaming_matrix_0_2 = streaming_matrix[0][1];
            top->io_Streaming_matrix_1_0 = streaming_matrix[1][0];
            top->io_Streaming_matrix_1_1 = streaming_matrix[1][1];
